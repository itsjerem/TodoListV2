...
@section('content')
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Modifier la catégorie</h2>
            <p class="mt-2 text-lg leading-8 text-gray-600">Modifiez les détails de la catégorie ici.</p>
        </div>
        <form method="POST" action="{{ route('categories.update', $category) }}" class="mx-auto mt-16 max-w-xl sm:mt-20">
            @csrf
            @method('PUT')
